...
import type { Board, Row, Cell } from '../utils/board';
...
function drawn(cells: Board) {
  return cells.some((row: Row) => row.some((cell: Cell) => cell !== DEAD));
}
